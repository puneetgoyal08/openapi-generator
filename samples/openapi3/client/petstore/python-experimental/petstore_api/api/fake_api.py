    ...
    def __init__(self, api_client=None):
        ...
        def __byte(
            ...
            **kwargs
            ...
            >>> thread = api.byte(async_req=True)
            >>> result = thread.get()


            Keyword Args:
                body (Byte): Input byte string as post body. [optional]
                _return_http_data_only (bool): response data without head status
                    code and headers. Default is True.
                _preload_content (bool): if False, the urllib3.HTTPResponse object
                    will be returned without reading/decoding response data.
        ...
        def __type_byte(
            ...
            **kwargs
            ...
            >>> thread = api.type_byte(async_req=True)
            >>> result = thread.get()
        ...
        self.type_byte = Endpoint(
            settings={
                'response_type': (str,),
                'auth': [],
                'endpoint_path': '/fake/types/byte',
                'operation_id': 'type_byte',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
